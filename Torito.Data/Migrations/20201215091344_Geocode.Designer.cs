...
namespace Torito.Data.Migrations
{
    ...
    [Migration("20201215091344_Geocode")]
            ...
            modelBuilder.Entity("Torito.Data.Persistance.DataModels.TweetDbo", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 15, 3, 13, 44, 396, DateTimeKind.Local).AddTicks(9686));

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 15, 3, 13, 44, 389, DateTimeKind.Local).AddTicks(9219));
