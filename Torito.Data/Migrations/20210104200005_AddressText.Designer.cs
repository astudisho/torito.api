...
namespace Torito.Data.Migrations
{
    ...
    [Migration("20210104200005_AddressText")]
    partial class AddressText
    {
            ...
            modelBuilder.Entity("Torito.Data.Persistance.DataModels.TweetDbo", b =>
                {
                    ...
                    b.Property<DateTime>("InsertedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 1, 4, 14, 0, 4, 768, DateTimeKind.Local).AddTicks(5821));

                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 1, 4, 14, 0, 4, 762, DateTimeKind.Local).AddTicks(8021));
